...
#test de la valeur entrée avant son intégration dans la liste des réponses
    if reponse >= 1 and reponse <= 4:
        ...
        while reponse < 1 or reponse > 4:
            print("Erreur : La réponse doit être 1, 2, 3 ou 4 !\n" + questions[j])
            reponse = int(input(" :> "))
        reponses.append(reponse)

#initialisation d'une liste contenant les adresses des questions (3, 5, 8, 9 et 10) dont la réponse doit être inversée
inverser = [2, 4, 7, 8, 9]
